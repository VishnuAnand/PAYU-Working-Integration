...
<html>
  ...
  <body onload="submitPayuForm()">
    ...
    <br/>
    <?php if($formError) { ?>
      <span style="color:red"><h4>Please confirm your details.</h4></span>
      <br/>
      <br/>
    <?php } ?>
    <form action="<?php echo $action; ?>" method="post" name="payuForm" >
      ...
      <table>
        ...
        <tr>
          <td>Amount: </td>
          <td><?php echo (empty($posted['amount'])) ? '' : $posted['amount'] ?><input hidden name="amount" value="<?php echo (empty($posted['amount'])) ? '' : $posted['amount'] ?>" /></td>
          <td>First Name: </td>
